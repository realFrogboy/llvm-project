//===-- RArchELFStreamer.h - RArch ELF Target Streamer ---------*- C++ -*--===//
//
...
#ifndef LLVM_LIB_TARGET_RArch_MCTARGETDESC_RArchELFSTREAMER_H
#define LLVM_LIB_TARGET_RArch_MCTARGETDESC_RArchELFSTREAMER_H
...
class RArchTargetELFStreamer : public RArchTargetStreamer {
private:
...
public:
  ...
  RArchTargetELFStreamer(MCStreamer &S, const MCSubtargetInfo &STI);
...
#endif // LLVM_LIB_TARGET_RArch_MCTARGETDESC_RArchELFSTREAMER_H
