//===- RArchMatInt.h - Immediate materialisation ---------------*- C++ -*--===//
//
...
#ifndef LLVM_LIB_TARGET_RArch_MCTARGETDESC_MATINT_H
#define LLVM_LIB_TARGET_RArch_MCTARGETDESC_MATINT_H
...
#endif // LLVM_LIB_TARGET_RArch_MCTARGETDESC_MATINT_H
