//===-- RArchAttributes.cpp - RArch Attributes ----------------------------===//
//
...
using namespace llvm::RArchAttrs;
...
constexpr TagNameMap RArchAttributeTags{TagData};
const TagNameMap &llvm::RArchAttrs::getRArchAttributeTags() {
  return RArchAttributeTags;
}
